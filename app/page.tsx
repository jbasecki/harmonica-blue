...
// THE "MAIL SLOT": This officially registers the database package
...
function DiscoverySanctuary({ initialData }: SanctuaryProps) {
  ...
  const elegantScript = "'Great Vibes', cursive"; // Vintage Copperplate Wedding Font
      ...
      {showVessel && (
        <div style={{ position: 'relative', zIndex: 2, height: '100%', display: 'flex', flexDirection: 'column', alignItems: 'center' }}>
          ...
          <div style={{ 
            ...
            {/* THE HARMONICA: Visual transformation of the content */}
