...
// 1. THIS IS THE "MAIL SLOT": It officially tells the Sanctuary to accept the database gift.
...
function DiscoverySanctuary({ initialData }: SanctuaryProps) {
  ...
  const vintageCursive = "'Great Vibes', cursive"; // Matches your copperplate wedding font

  // HARMONICA ENGINE: Transforms words into art tiles
  ...
  return (
    <main style={{ height: '100vh', width: '100vw', background: '#000', color: '#D4AF37', overflow: 'hidden', position: 'relative' }}>
      ...
      {/* FULL BACKGROUND VIDEO: Use CLOSE to let it "dance" across the whole screen */}
      ...
      {showVessel && (
        <div style={{ position: 'relative', zIndex: 2, height: '100%', display: 'flex', flexDirection: 'column', alignItems: 'center' }}>
          ...
          <div style={{ 
            ...
            {/* HARMONICA DISPLAY: Last words of the message transform into art tiles */}
