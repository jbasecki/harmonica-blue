...
export function DiscoverySanctuary({ initialData }: SanctuaryProps) {
  ...
  const vintageFont = "'Great Vibes', cursive";
      ...
      {showVessel && (
        <div style={{ position: 'relative', zIndex: 2, height: '100%', display: 'flex', flexDirection: 'column', alignItems: 'center' }}>
          ...
          <div style={{ marginTop: '16vh', display: 'flex', flexDirection: 'column', alignItems: 'center', gap: '8px' }}>
            ...
            {isReceiver && fromName && (
              <div style={{ fontFamily: vintageFont, fontSize: '1.2rem', color: '#D4AF37', opacity: 0.7 }}>
                from {fromName}
              </div>
            )}
          </div>
          ...
          <div style={{ 
            ...
            <textarea 
              ...
              style={{ width: '100%', height: '120px', background: 'transparent', border: 'none', textAlign: 'center', fontSize: '1.4rem', fontFamily: vintageFont, color: '#D4AF37', outline: 'none', resize: 'none' }} 
            />
